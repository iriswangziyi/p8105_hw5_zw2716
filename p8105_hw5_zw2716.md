...
hypothesis is \(H0: \mu = 0\) for all different \(\mu\) (effect sizes),
so as \(\mu\) increase, the more times null was rejected, and thus
higher power of the test.
...
<img src="p8105_hw5_zw2716_files/figure-gfm/unnamed-chunk-13-1.png" width="90%" />
